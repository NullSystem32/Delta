...
const translations = {
    'pt': {
        ...
        'pricelist_hello': 'Olá! Eu sou o Null.',
        ...
        'pricelist_prophetia_text': 'Atualmente estou desenvolvendo um jogo de RPG chamado PROPHETIA. Para custear ajuda com o projeto, comecei a oferecer comissões de programação. Também percebi que vou precisar de um grande orçamento só para patrocinar meu jogo no Roblox para que as pessoas possam encontrá-lo. (Sim, Grow a Garden não chegou a 25M de jogadores porque é bom.)',
    ...
    'es': {
        ...
        'pricelist_project_messier': '• Messier Society',
        'pricelist_project_messier_desc': 'es un spin-off ambientado en un laboratorio de ciencia ficción bizarro donde debes descubrir qué está pasando y, lo más importante — escapar. (Messier Society todavía está en progreso.)',
    ...
    'fr': {
        ...
        'pricelist_project_messier': '• Messier Society',
        'pricelist_project_messier_desc': 'est un spin-off situé dans un laboratoire de science-fiction bizarre où vous devez découvrir ce qui se passe et surtout — vous échapper. (Messier Society est toujours en cours.)',
